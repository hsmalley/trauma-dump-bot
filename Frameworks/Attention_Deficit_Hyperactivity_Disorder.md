...
| "You can hyperfocus when you want, so you can pay attention when you want." | "Hyperfocus is a symptom of **dysregulation**, not control. It's an *inability to disengage* from a task that provides high interest/stimulation, which is the flip side of *inability to engage* with a boring one." |
...
-   Dodson, R. (2007). *What is Rejection Sensitive Dysphoria?* (Clinical work).
-   Tuckman, A. (2012). *Integrative treatment for adult ADHD: A practical guide to empowering clients.*