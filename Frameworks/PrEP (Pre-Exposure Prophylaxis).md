...
- *"PrEP is 100% effective for all exposures."* No — it is highly effective when used correctly, but not absolute, and it does not prevent other STIs.  
- *"PrEP is only for gay men."* No — PrEP is for anyone at risk, including cisgender women, transgender people, people who inject drugs, and others.  
